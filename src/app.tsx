        ...
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <h1 className="text-lg font-semibold text-kumo-default">
              <span className="mr-2">⛅</span>Supply Chain Capacity & Risk Agent
            </h1>
            ...
            <Empty
              ...
              contents={
                <div className="flex flex-wrap justify-center gap-2">
                  {[
                    "Analyze capacity risk for 800 units of demand across three suppliers",
                    "What happens if one supplier increases capacity by 100 units?",
                    "Identify the capacity gap and recommended action",
                    "Compare the risk before and after a supplier capacity increase"
                  ].map((prompt) => (
                    <Button
                      key={prompt}
                      variant="outline"
